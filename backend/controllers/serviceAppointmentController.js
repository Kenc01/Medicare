...
//this function will parse a time string like "2:30 PM" or "14:30" and return an object with hour, minute, and ampm
...
//to get Service Appointments for a user
...
export const getServiceAppointmentStats = async (req, res) => {
  try {
    const services = await Service.aggregate([
      ...
      { $sort: { createdAt: -1 } },
    ]); //it will give you total appointments, complete appt
